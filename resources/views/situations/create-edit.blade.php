        ...
        <div class="panel-body">
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    {{Form::select('show',[1 => 'Afficher dans le tableau de synthèse', 0 => 'Ne pas afficher dans le tableau de synthèse'],isset($situation) ? $situation->show : 0, ['id' => 'show', 'class' =>'form-control'])}}
                </div>
